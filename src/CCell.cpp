...
CCell::CCell(string text = "",
             set<pair<int, int>> parents = set<pair<int, int>>())
    : m_textVal(text), m_parentCells(parents) {}
...
set<pair<int, int>> CCell::retParentCells() { return m_parentCells; }
...
string CCell::getText() const { return m_textVal; }
